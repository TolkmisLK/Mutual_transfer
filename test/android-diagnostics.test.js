...
unstructured secret-password`);
  assert.deepEqual(report, { fatalSignal: true, fatalJava: true, classes: ['java.lang.IllegalStateException', 'dev.ncc.BadException'], frames: ['dev.ncc.mutualtransfer.MainActivity.onDestroy(MainActivity.java:159)'] });
